...
import type { LineRange } from './file-navigation';

/**
 * A range that has just been picked, with the text it stood for captured at pick time.
 *
 * {@link LineRange} itself is imported rather than declared here, which is the opposite of the
 * original's arrangement: navigation landed in this SPA before the viewer did, and the URL contract —
 * `lines=12-20` — is what owns the shape either way.
 */
