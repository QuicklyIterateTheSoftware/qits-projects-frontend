 ...
 *
 * Copied from qits-spa-workspaces' detail shell. Its two cross-tab presses — a reference chip's "open
 * these lines" and an element's "open its source" — write the file browser's URL parameters through
 * {@link FileNavigation}, and **nothing in this SPA reads them until the Files tab lands.** The presses
 * are kept rather than trimmed: a URL write costs nothing to make early, and dropping them would mean
 * copying this file twice.
 *
 * ## What it loads
 *
