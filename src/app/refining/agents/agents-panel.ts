 ...
 *    never been opened, and does without the badges if it fails. **In this SPA it always pays**, until
 *    the Files tab lands and starts publishing its own — the entry is the seam, and it works with one
 *    end of it missing precisely so this tab could be copied first.
 *
