 ...
 *
 * Copied from qits-spa-workspaces' detail shell. **The refining page hands it only the workspaces on
 * `refining/…` branches**, because a press has to land somewhere and this SPA addresses a workspace by
 * the epic it refines — so here the row reads as *which epics have an agent working*.
 *
