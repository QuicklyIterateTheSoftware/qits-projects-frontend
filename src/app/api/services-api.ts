...
export class ServicesApi {
   ...
   * narrowing — and because one entry feeds the panel, the tab's aggregate dot and the Web view's
   * picker, which only stays one entry while the key and the shape stay identical.
   */
