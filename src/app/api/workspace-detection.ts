 ...
 *
 * Copied from qits-spa-workspaces, where the plan names them: *"one detection entry feeds the file
 * browser and the plugin recommender."* Only the recommender exists here so far; see {@link ensure}.
