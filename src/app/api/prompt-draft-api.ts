 ...
 *
 * Copied from qits-spa-workspaces with the refining page's prompt panel. It reaches qits-workspaces
 * rather than qits-projects, so it is a *workspace* draft even here — a refining epic's draft is the
 * draft of the workspace on `refining/<slug>`, and there is nothing project-side to store it in.
 */
