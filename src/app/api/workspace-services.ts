 ...
 *
 * Three surfaces read this list — the Services panel, the tab's aggregate label dot and the Web
 * view's service picker — and the rule that makes three readers affordable is **identical key and
 * identical result shape**. In a signals codebase that means one `@Injectable` owning one signal,
