 ...
 * here, and copied from qits-spa-workspaces with the refining page's Agents tab. `POST /agents` lives on {@link ./commands-api#CommandsApi} because a coding agent **is** a
