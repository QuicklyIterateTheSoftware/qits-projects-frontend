 ...
 * from.
 *
 * **It arrives here one phase ahead of its main reader**, because the plugin recommender wants
 * `/detection` and the contract is not worth splitting in half to defer three methods: a hand-written
 * client mirrors one document, and half of it would have to be reunited by the next change either way.
 * Copied from qits-spa-workspaces.
 *
